...
4. В global_imports указывай только внешние зависимости (не stdlib)
...
{{
  ...
  "global_imports": {{
    "имя_файла.{{ext}}": ["from external_lib import X"]
  }}
}}
""",
...
{{
  ...
  "feedback": "Что исправить с указанием строк (пусто если APPROVE_ALL)",
